  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-2xl border border-neutral p-4">
          ...
          {(caseData.documents_missing || 0) > 0 && (
            <Link href="/dokumenty" className="text-xs text-primary mt-1 block">не хватает {caseData.documents_missing}</Link>
          )}
        </div>
        <div className="bg-white rounded-2xl border border-neutral p-4">
          ...
          {caseData.lawyer && <Link href="/konsultacii" className="text-xs text-primary mt-1 block">подробнее</Link>}
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
        <Link href="/dokumenty" className="bg-white rounded-xl border border-neutral p-4 text-center hover:bg-surface-muted transition-colors">
          <span className="text-xl">📄</span>
          <p className="text-xs text-text-body mt-2">Документы</p>
        </Link>
        <Link href="/kreditory" className="bg-white rounded-xl border border-neutral p-4 text-center hover:bg-surface-muted transition-colors">
          <span className="text-xl">🏦</span>
          <p className="text-xs text-text-body mt-2">Кредиторы</p>
        </Link>
        <Link href="/chat" className="bg-white rounded-xl border border-neutral p-4 text-center hover:bg-surface-muted transition-colors">
          <span className="text-xl">💬</span>
          <p className="text-xs text-text-body mt-2">AI-ассистент</p>
        </Link>
        <Link href="/konsultacii" className="bg-white rounded-xl border border-neutral p-4 text-center hover:bg-surface-muted transition-colors">
          <span className="text-xl">📅</span>
