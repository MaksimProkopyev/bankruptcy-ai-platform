...
export default function NewCasePage() {
  ...
  return (
    <div className="max-w-2xl">
      <Link href="/cases" className="text-sm text-gray-400 hover:text-gray-600 mb-4 block">
        ← Все дела
      </Link>
      ...
      {step === "client" && (
        <form onSubmit={handleCreateClient} className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
          ...
          <button type="submit" disabled={loading} className="px-6 py-2.5 bg-accent text-text-on-dark rounded-lg text-sm font-medium hover:bg-accent-hover disabled:opacity-50">
