...
interface Draft { id: string; title: string; status: string; case_id: string; created_at: string; requires_client_signature: boolean; }
interface Invoice { id: string; invoice_number: string; total_amount: number; status: string; case_id: string; due_date: string; created_at: string; }
