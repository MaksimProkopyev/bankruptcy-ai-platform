...
export default function LeadgenLoginPage() {
    ...
    <div className="min-h-screen flex items-center justify-center bg-surface">
      <div className="w-full max-w-sm px-6">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-text-muted mt-1">Лидогенерация — вход</p>
        </div>
        <form onSubmit={handleSubmit} className="bg-white p-8 rounded-2xl border border-neutral shadow-card">
          {error && (
            <div className="mb-4 p-3 bg-danger/10 border border-danger rounded-xl text-sm text-danger">{error}</div>
          )}
          <div className="mb-4">
