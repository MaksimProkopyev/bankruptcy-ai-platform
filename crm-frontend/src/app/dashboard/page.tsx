  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/cases/new" className="px-4 py-2 text-sm bg-accent text-text-on-dark rounded-lg hover:bg-accent-hover">
          + Новое дело
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl border border-neutral shadow-card p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/deadlines" className="text-xs text-primary hover:text-primary-dark">Все →</Link>
          </div>
        ...
        <div className="bg-white rounded-xl border border-neutral shadow-card p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/cases?status=lead" className="text-xs text-primary hover:text-primary-dark">Все →</Link>
          </div>
          <p className="text-sm text-text-muted">Загрузка...</p>
        </div>
      </div>
