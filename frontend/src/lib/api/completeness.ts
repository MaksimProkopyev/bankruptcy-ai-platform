...
export interface CompletenessItemResponse {
  id: string;                    // UUID
  checklist_item_id: string;     // "passport_main"
  name: string;
  category: string;
  required: boolean;
  description: string;
...
/**
 * Get completeness progress for a case
 */
...
/**
 * Initialize checklist for a case
 */
...
/**
 * Run auto-matching of documents
 */
