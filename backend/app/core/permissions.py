...
PERMISSIONS: Dict[str, Dict[str, Set[UserRole]]] = {
    ...
    "cases": {
        ...
        "write": {UserRole.admin, UserRole.operations_director, UserRole.lawyer, UserRole.client_manager},
    ...
    "leads": {
        "read": {UserRole.admin, UserRole.operations_director, UserRole.client_manager, UserRole.marketer},
        "write": {UserRole.admin, UserRole.operations_director, UserRole.client_manager},
        "delete": {UserRole.admin, UserRole.operations_director},
    },
    "tasks": {
    ...
    "deadlines": {
        ...
        "write": {UserRole.admin, UserRole.operations_director, UserRole.lawyer, UserRole.paralegal},
        "delete": {UserRole.admin, UserRole.operations_director, UserRole.lawyer},
    },
    "knowledge": {
        "read": {
...
require_staff = require_roles(
    UserRole.admin, UserRole.operations_director, UserRole.lawyer, UserRole.paralegal, UserRole.client_manager
)
