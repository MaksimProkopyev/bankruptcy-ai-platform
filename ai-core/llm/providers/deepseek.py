...
class DeepSeekProvider(LLMProvider):
    ...
    DEFAULT_EMBED_MODEL = "deepseek-embedding"  # Note: DeepSeek may not have embedding API
    ...
    def __init__(self, api_key: str | None = None, **kwargs: Any) -> None:
        ...
        if not key:
            raise ValueError(
                "DeepSeek API key not provided and DEEPSEEK_API_KEY env var not set"
            )
        ...
        try:
            ...
            if "context_length" in str(e).lower() or "maximum context" in str(e).lower():
                ...
                if match:
                    ...
                    max_allowed = 128000  # default for DeepSeek
            ...
            logger.exception("Unexpected error in DeepSeek provider")
            raise LLMProviderUnavailableError(
                provider=self.provider_name,
                model=model,
    ...
    async def embed(
        ...
        **kwargs: Any,
        ...
        # DeepSeek may not have embedding API; raise NotImplementedError
        raise NotImplementedError(
            "DeepSeek provider does not support embeddings yet. "
